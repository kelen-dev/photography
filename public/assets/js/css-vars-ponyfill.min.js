...
!function (e, t) {
    ...
    function t(e) {
        ...
        }, n = Array.isArray(e) ? e : [e], o = Array.apply(null, Array(n.length)).map((function (e) {
            return null
        }));
        ...
        n.forEach((function (e, t) {
            if (i.setAttribute("href", e), i.href = String(i.href), Boolean(document.all && !window.atob) && i.host.split(":")[0] !== location.host.split(":")[0]) {
                ...
                o.open("GET", e), r.mimeType && o.overrideMimeType && o.overrideMimeType(r.mimeType), r.onBeforeSend(o, e, t), o.onreadystatechange = function () {
                    4 === o.readyState && (200 === o.status && s(o.responseText) || 0 === o.status && s(o.responseText) ? c(o.responseText, t) : a(o, t))
                }, o.send()
            }
        }))
    }
    ...
    function r(e) {
        var r = /\/\*[\s\S]+?\*\//g, o = /(?:@import\s*)(?:url\(\s*)?(?:['"])([^'"]*)(?:['"])(?:\s*\))?(?:[^;]*;)/g,
            s = {
        ...
        function l(e, t) {
            ...
            return a.rules = (e.replace(r, "").match(o) || []).filter((function (e) {
                ...
                var o = a.urls[r], s = n(a.absoluteUrls[r], t);
        ...
        function f(e, r, n, o) {
            var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [],
                c = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : [], i = l(e, n, c);
            i.rules.length ? t(i.absoluteUrls, {
                onBeforeSend: function (e, t, n) {
                    s.onBeforeSend(e, r, t)
                }, onSuccess: function (e, t, n) {
                    var o = s.onSuccess(e, r, t), a = l(e = !1 === o ? "" : o || e, t, c);
        ...
        a.length ? a.forEach((function (e, r) {
            var o = e.getAttribute("href"), a = e.getAttribute("rel"),
                l = "link" === e.nodeName.toLowerCase() && o && a && -1 !== a.toLowerCase().indexOf("stylesheet"),
                f = !1 !== s.skipDisabled && e.disabled, d = "style" === e.nodeName.toLowerCase();
            if (l && !f) t(o, {
                mimeType: "text/css", onBeforeSend: function (t, r, n) {
    ...
    function n(e, t) {
        var r = document.implementation.createHTMLDocument(""), n = r.createElement("base"), o = r.createElement("a");
    ...
    function i(t) {
        var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            n = {preserveStatic: !0, removeComments: !1}, s = e({}, n, r), a = [];
        ...
        function C() {
            if (i(/^@host\s*/)) return {type: "host", rules: L()}
        }
        ...
        function _() {
            ...
            var a = m() || [], i = s.preserveStatic ? h() : h().filter((function (e) {
                var t = a.some((function (e) {
                    return /:(?:root|host)(?![.:#(])/.test(e)
                })) && /^--\S/.test(e.property), r = /var\(/.test(e.value);
                return t || r
            }));
        ...
        function L(e) {
            ...
            for (var r, n = p(); t.length && (e || "}" !== t[0]) && (r = j() || _());) r.type && n.push(r), n = n.concat(p());
            return e || l() ? n : c("missing '}'")
        }

        return {type: "stylesheet", stylesheet: {rules: L(!0), errors: a}}
    }
    ...
    function u(t) {
        ...
        }, o = e({}, n, r), s = new RegExp(":".concat(o.parseHost ? "host" : "root", "$"));
    ...
    function l(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "",
            r = arguments.length > 2 ? arguments[2] : void 0, n = {
                charset: function (e) {
    ...
    function d(t) {
        ...
        return "string" == typeof t && (t = i(t, o)), f(t.stylesheet, (function (e, t) {
            for (var r = 0; r < e.length; r++) {
                var n = e[r], s = n.type, a = n.property, c = n.value;
                if ("declaration" === s) if (o.preserveVars || !a || 0 !== a.indexOf("--")) {
                    if (-1 !== c.indexOf("var(")) {
                        var i = m(c, o);
    ...
    var v = "undefined" != typeof window, h = v && window.CSS && window.CSS.supports && window.CSS.supports("(--a: 0)"),
        y = {group: 0, job: 0}, g = {
        ...
        }, S = {dom: {}, job: {}, user: {}}, E = !1, w = null, C = 0, x = null, A = !1;

    function O() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = "cssVars(): ", o = e({}, g, t);
        ...
        function c(e) {
            o.onFinally(Boolean(e), h, V() - o.__benchmark)
        }

        if (v) {
            if (o.watch) return o.watch = g.watch, k(o), void O(o);
            if (!1 === o.watch && w && (w.disconnect(), w = null), !o.__benchmark) {
                if (E === o.rootElement) return void j(t);
                var f = Array.apply(null, o.rootElement.querySelectorAll('[data-cssvars]:not([data-cssvars="out"])'));
                if (o.__benchmark = V(), o.exclude = [w ? '[data-cssvars]:not([data-cssvars=""])' : '[data-cssvars="out"]', "link[disabled]", o.exclude].filter((function (e) {
                    return e
                })).join(","), o.variables = M(o.variables), f.forEach((function (e) {
                    ...
                    var p = Array.apply(null, o.rootElement.querySelectorAll('[data-cssvars="out"]'));
            ...
            if ("loading" !== document.readyState) if (h && o.onlyLegacy) {
                var m = !1;
                if (o.updateDOM) {
                ...
                c(m)
            } else !A && (o.shadowDOM || o.rootElement.shadowRoot || o.rootElement.host) ? r({
                rootElement: g.rootElement,
                include: g.include,
                exclude: o.exclude,
                skipDisabled: !1,
                onSuccess: function (e, t, r) {
                    return (e = ((e = e.replace(b.cssComments, "").replace(b.cssMediaQueries, "")).match(b.cssVarDeclRules) || []).join("")) || !1
                },
                onComplete: function (e, t, r) {
                    u(e, {store: S.dom, onWarning: a}), A = !0, O(o)
                }
            }) : (E = o.rootElement, r({
                ...
                onError: function (e, t, r) {
                    var n = e.responseURL || T(r, location.href),
                ...
                onSuccess: function (e, t, r) {
                    var n = "link" === t.nodeName.toLowerCase(),
                        s = "style" === t.nodeName.toLowerCase() && e !== t.textContent, a = o.onSuccess(e, t, r);
                    return e = void 0 !== a && !1 === Boolean(a) ? "" : a || e, o.updateURLs && (n || s) && (e = L(e, r)), e
                },
                onComplete: function (t, r) {
                    ...
                    if (S.job = {}, n.forEach((function (e, t) {
                    ...
                    })), e(S.job, S.dom), o.updateDOM ? (e(S.user, o.variables), e(S.job, S.user)) : (e(S.job, S.user, o.variables), e(f, o.variables)), y.job > 0 && Boolean(Object.keys(S.job).length > Object.keys(f).length || Boolean(Object.keys(f).length && Object.keys(S.job).some((function (e) {
                        return S.job[e] !== f[e]
                    }))))) R(o.rootElement), O(o); else {
                        var p = [], m = [], v = !1;
                        if (o.updateDOM && y.job++, n.forEach((function (t, n) {
                            var c = !t.__cssVars.tree;
                            if (t.__cssVars.tree) try {
                                d(t.__cssVars.tree, e({}, o, {variables: S.job, onWarning: a}));
                                var i = l(t.__cssVars.tree);
                                if (o.updateDOM) {
                                    var u = r[n], f = b.cssVarFunc.test(u);
                                    if (t.getAttribute("data-cssvars") || t.setAttribute("data-cssvars", "src"), i.length && f) {
                                        ...
                                        v = v || b.cssKeyframes.test(i), o.preserveStatic && t.sheet && (t.sheet.disabled = !0), E.hasAttribute("data-cssvars") || E.setAttribute("data-cssvars", "out"), g === t.textContent.replace(/\s/g, "") ? (c = !0, E && E.parentNode && (t.removeAttribute("data-cssvars-group"), E.parentNode.removeChild(E))) : g !== E.textContent.replace(/\s/g, "") && ([t, E].forEach((function (e) {
                        ...
                        })), C = o.rootElement.querySelectorAll('[data-cssvars]:not([data-cssvars="out"])').length, o.shadowDOM) for (var h, g = [].concat(o.rootElement).concat(Array.apply(null, o.rootElement.querySelectorAll("*"))), w = 0; h = g[w]; ++w) if (h.shadowRoot && h.shadowRoot.querySelector("style")) {
                            var x = e({}, o, {rootElement: h.shadowRoot});
                            O(x)
                        }
                        o.updateDOM && v && _(o.rootElement), E = !1, o.onComplete(p.join(""), m, JSON.parse(JSON.stringify(S.job)), V() - o.__benchmark), c(m.length)
                    }
                }
    ...
    function k(e) {
        function t(e) {
            var t = r(e) && e.hasAttribute("disabled"), n = (e.sheet || {}).disabled;
            return t || n
        }
            ...
            o.some((function (o) {
                return function (n) {
                    ...
                    if ("attributes" === n.type && r(n.target) && !t(n.target)) {
                        var s = "disabled" === n.attributeName, a = "href" === n.attributeName,
                    ...
                    var t = !1;
                    if ("childList" === e.type) {
                        var r = n(e.target), o = "out" === e.target.getAttribute("data-cssvars");
                        t = r && !o
                    }
                    return t
                }(o) || function (e) {
                    ...
                    var r = !1;
                    return "childList" === t.type && (r = Array.apply(null, t.removedNodes).some((function (t) {
                        var r = 1 === t.nodeType, n = r && "out" === t.getAttribute("data-cssvars"),
                            o = r && "src" === t.getAttribute("data-cssvars"), s = o;
                        if (o || n) {
    ...
    function L(e, t) {
        return (e.replace(b.cssComments, "").match(b.cssUrls) || []).forEach((function (r) {
            var n = r.replace(b.cssUrls, "$1"), o = T(n, t);
    ...
    function T(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : location.href,
            r = document.implementation.createHTMLDocument(""), n = r.createElement("base"), o = r.createElement("a");
    ...
    function R(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
            r = Array.apply(null, e.querySelectorAll('[data-cssvars="skip"],[data-cssvars="src"]'));
    ...
    return O.reset = function () {
        for (var e in y.job = 0, y.group = 0, E = !1, w && (w.disconnect(), w = null), C = 0, x = null, A = !1, S) S[e] = {}
    }, O
}));
