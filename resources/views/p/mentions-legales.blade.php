...
@section('content')
    <div class="container content" id="p-mentions-legales">
        <div class="title">
            <h1>
                Mentions légales
            </h1>

            <h3>En vigueur au 11/01/2023</h3>
        </div>
        ...
        <p>
            L'hébergeur du Site est la société o2switch, dont le siège social est situé au CHEMIN DES
            PARDIAUX 63000 CLERMONT-FERRAND , avec le numéro de téléphone : 0444446040 + adresse
            mail de contact
        </p>
