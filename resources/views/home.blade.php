        ...
        <div class="wrapper">
            ...
            <div class="experience">
                ...
                <ul id="la-clandestine">
                    ...
                    <li class="description">
                        Développement + maintenance du site de <a href="https://ecolededanselaclandestine.fr" title="Accéder au site"><strong>la
    ...
    <div class="container">
        ...
        <ul class="wrapper">
            ...
            <li>
                ...
                <img class="img-fluid" src="{{ asset('assets/img/projects/accueil-kelens-fr.webp') }}" alt="KelenS CORP">
            </li>
        </ul>
    </div>
</section>
